        ...
        <form name="boardWriteForm">
        	...
        	%>
        		...
        		<tr>
        			<td>제목</td>
        			<td>
        				<input style="width:700px;" type="text" name="title" placeholder="게시글 제목을 입력하세요." value="<%=bean.getB_in_title()%>">
        			</td>
        		</tr> 		
        		<tr>
        			<td colspan="2">
        			<div id="boardWriteCon">
                		<textarea name="content"><%=bean.getB_in_content() %></textarea>
                	</div>
                	</td>
        		</tr>
        		<tr>
        			<td colspan="2" align="right">
        				...
        				<input type="hidden" name="no" value="<%=bean.getB_in_no()%>">
